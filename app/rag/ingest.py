...
from langchain_google_genai import GoogleGenerativeAIEmbeddings  # <-- CHANGED: Replaced OpenAIEmbeddings
...
def build_vectorstore():
    ...
    embeddings = GoogleGenerativeAIEmbeddings(  # <-- CHANGED: Use Gemini embeddings
